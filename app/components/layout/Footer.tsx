...
export default function Footer() {
  ...
  return (
    <footer className="bg-clinic-charcoal text-white/70">
      {/* Main Footer */}
      <div className="mx-auto max-w-6xl px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed">
            Premium dental care for the whole family. We make every smile count.
          </p>
          <div className="mt-4 flex gap-3">
            <a
              href="#"
              className="text-white/40 hover:text-clinic-teal transition-colors"
              aria-label="Facebook"
            >
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li className="flex items-start gap-3">
              <svg className="w-5 h-5 text-clinic-teal shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li className="flex items-center gap-3">
              <svg className="w-5 h-5 text-clinic-teal shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-6xl px-6 py-6 flex flex-col md:flex-row items-center justify-between gap-4 text-sm">
          <p>
            &copy; {currentYear} Dental Clinic. All rights reserved.
          </p>
